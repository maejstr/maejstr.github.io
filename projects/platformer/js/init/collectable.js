(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.kennedi, 600, 530, 0, 1)
        collectable.create(type.db, 600, 350, 0, 0)
        collectable.create(type.max, 100, 420, 2, 0)
        collectable.create(type.grace, 450, 150, 0, 1)
